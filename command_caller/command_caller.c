...
void call_command(command cmd) {
    ...
    switch (cmd.command_code) {
        ...
        case COMMAND_CFP_GPIO_DEBUG:
            // cfp_gpio_debug();
            // break;
            xil_printf("CFP GPIO commands not yet implemented\r\n");
            break;
        ...
        case COMMAND_QSFP_GPIO_DEBUG:
            // is this useful in a command specification for a board? I mean
            // I know this is nice for an interactive command line application
            qsfp_gpio_debug();
            break;
        ...
        case COMMAND_INVALID:
            ...
            switch (cmd.args[0]) {
                ...
                case ERROR_INVALID_CFP_MDIO_ADDRESS:
                    xil_printf("The address entered is out of range\r\n");
                    xil_printf("Valid range for CFP memory addresses is [0:31]\r\n");
                    break;
                case ERROR_OTHER:
