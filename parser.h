...
#define ERROR_INVALID_GPIO_VALUE 1
#define ERROR_INVALID_QSFP_IIC_READ_PAGE 2
#define ERROR_INVALID_QSFP_IIC_READ_START_ADDRESS 3
#define ERROR_INVALID_QSFP_IIC_READ_END_ADDRESS 4
#define ERROR_PEK_WRITE_DATA_TOO_LONG 5
#define ERROR_INVALID_PEK_IIC_WRITE_PAGE 6
#define ERROR_INVALID_PEK_START_ADDRESS 7
#define ERROR_INVALID_PEK_IIC_DATA_TYPE 8
#define ERROR_INVALID_PEK_PORT 9
#define ERROR_INVALID_PEK_IIC_READ_PAGE 10
#define ERROR_INVALID_PEK_IIC_READ_START_ADDRESS 11
#define ERROR_INVALID_PEK_IIC_READ_END_ADDRESS 12
